...
public class Course_LinkList {
	...
	public void addFirstNode(String rName) {
	...
	public void insertNode(int index, String rName) {
		CourseNode node = new CourseNode(rName);
	...
	public void deleteByData(String rName) {
		CourseNode current = first;
		CourseNode previous = first;
	...
	public CourseNode findByData(String rName) {
		CourseNode current = first;
		while (current.rName != rName) {
			if (current.next == null)
				return null;
